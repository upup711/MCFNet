...
def train_epoch(model, train_loader, criterion, optimizer):
    ...
    tar = np.array([])
    pre = np.array([])
    for batch_idx, (batch_data11, batch_data21, batch_data12, batch_data22, batch_data13, batch_data23, batch_data14, batch_data24, batch_target) in enumerate(train_loader):
        ...
        batch_data14 = batch_data14.cuda()
        batch_data24 = batch_data24.cuda()
        batch_target = batch_target.cuda()

        optimizer.zero_grad()
        batch_pred = model(batch_data11, batch_data21, batch_data12, batch_data22, batch_data13, batch_data23, batch_data14, batch_data24)
...
def valid_epoch(model, valid_loader, criterion):
    ...
    tar = np.array([])
    pre = np.array([])
    for batch_idx, (batch_data11, batch_data21, batch_data12, batch_data22, batch_data13, batch_data23, batch_data14, batch_data24, batch_target) in enumerate(valid_loader):
        batch_data11 = batch_data11.cuda()
        batch_data21 = batch_data21.cuda()
        batch_data12 = batch_data12.cuda()
        batch_data22 = batch_data22.cuda()
